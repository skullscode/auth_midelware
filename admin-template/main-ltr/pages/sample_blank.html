...
<!-- Mirrored from crmx-admin-template.multipurposethemes.com/main-ltr/pages/sample_blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jun 2019 04:48:07 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>CrmX Admin - Dashboard  Blank Page </title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu animated flipInX">
              <!-- User image -->
              <li class="user-header bg-img" style="background-image: url(../images/user-info.html)" data-overlay="3">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../index-2.html"><i class="ti-more"></i>Main Dashboard</a></li>
            <li><a href="../index-3.html"><i class="ti-more"></i>e-Commerce Dashboard</a></li>
            <li><a href="../index-4.html"><i class="ti-more"></i>Analytics</a></li>
            <li><a href="../index-5.html"><i class="ti-more"></i>Hospital</a></li>
            <li><a href="../index-6.html"><i class="ti-more"></i>Banking</a></li>
            <li><a href="../index-7.html"><i class="ti-more"></i>Cab Booking</a></li>
          </ul>
        </li>  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="page_layout_inner_left_sidebar.html"><i class="ti-more"></i>Inner Left Sidebar </a></li>
            <li><a href="page_layout_inner_right_sidebar.html"><i class="ti-more"></i>Inner Right Sidebar </a></li>
            <li><a href="page_layout_inner_fixed_left_sidebar.html"><i class="ti-more"></i>Inner Fixed Left Sidebar </a></li>
            <li><a href="page_layout_inner_fixed_right_sidebar.html"><i class="ti-more"></i>Inner Fixed Right Sidebar </a></li>
          </ul>
        </li>
